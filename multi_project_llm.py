    ...
    def download_spam_csv():
        ...
        st.markdown(
            create_download_link(
                ...
                "📥 Download Spam Classifier Report (CSV)",
                "report"
            ),
            unsafe_allow_html=True
        )
    ...
    def download_detect_csv():
        ...
        st.markdown(
            create_download_link(
                ...
                "📥 Download Language Detection Report (CSV)",
                "report"
            ),
            unsafe_allow_html=True
        )
    ...
    with col2:
        ...
        st.markdown(
            create_download_link(
                ...
                "⬇️ Download Sample Language Detection Dataset",
                "detect"
            ),
            unsafe_allow_html=True
        )
    ...
    def download_food_csv():
        ...
        st.markdown(
            create_download_link(
                ...
                "📥 Download Food Sentiment Report (CSV)",
                "report"
            ),
            unsafe_allow_html=True
        )
    ...
    with col2:
        ...
        st.markdown(
            create_download_link(
                csv,
                "food_sentiment.csv",
                "⬇️ Download Sample Food Sentiment Dataset",
                "food"
            ),
            unsafe_allow_html=True
        )
    ...
    def download_translate_csv():
        ...
        st.markdown(
            create_download_link(
                ...
                "📥 Download Machine Translation Report (CSV)",
                "report"
            ),
            unsafe_allow_html=True
        )
    ...
    with col2:
        ...
        st.markdown(
            create_download_link(
                ...
                "⬇️ Download Sample Machine Translate Dataset",
                "translate"
            ),
            unsafe_allow_html=True
        )
    ...
    def download_News_csv():
        ...
        st.markdown(
            create_download_link(
                ...
                "📥 Download News Classification Report (CSV)",
                "report"
            ),
            unsafe_allow_html=True
        )
    ...
    with col2:
        ...
        st.markdown(
            create_download_link(
                ...
                "⬇️ Download Sample News Classification Dataset",
                "news"
            ),
            unsafe_allow_html=True
        )
